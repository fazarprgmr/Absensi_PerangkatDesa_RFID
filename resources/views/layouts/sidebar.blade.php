<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        @if (auth()->user()->role === 'admin')
            <div class="menu-section">
                <div class="menu-section-title">DATA USER</div>
                <ul class="nav flex-column">
                    <li class="nav-item">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        ...
                        <ul id="masterSubmenu" class="submenu collapse  list-unstyled {{ $isMaster ? 'show' : '' }}">
                            <li><a class="nav-link {{ request()->is('perangkat-desa*') ? 'active' : '' }}"
        ...
        <div class="menu-section">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    @php
                        $isKehadiran = request()->is('kehadiran*') || request()->is('rekap*');
                    @endphp
                    ...
                    <ul id="kehadiranSubmenu" class="submenu collapse  list-unstyled {{ $isKehadiran ? 'show' : '' }}">
                        <li><a class="nav-link {{ request()->is('kehadiran*') ? 'active' : '' }}"
                                href="{{ route('kehadiran.index') }}">Kehadiran</a></li>
                        <li><a class="nav-link {{ request()->is('rekap*') ? 'active' : '' }}"
                                href="{{ route('rekap.index') }}">Rekap Absensi</a></li>
                    </ul>
                </li>
            </ul>
        </div>
